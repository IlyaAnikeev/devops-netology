...
![vers](img/1_1_elk_run.png)

![vers](img/1_2_dockerps.png)

- скриншот интерфейса kibana:

![vers](img/1_3_kibana.png)

![vers](img/1_4_kibana.png)
...
- создал index-pattern с именем logstash_netology:

![vers](img/2_2_discover.png)
