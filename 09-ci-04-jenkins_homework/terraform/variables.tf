...
variable "ssh_public_key" {
  ...
  default     = {
    ...
    ssh-keys          = "centos:ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAICi1yXbfR0KgmVeezQhjhI0FxxmjwUGw0EYhxpfRYAse ilya@anikeev"
  }
